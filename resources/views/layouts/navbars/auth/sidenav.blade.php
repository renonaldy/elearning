<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'matapelajaran') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'matapelajaran']) }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'jadwalujian') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'jadwalujian']) }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'materi') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'materi']) }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'tugas') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'tugas']) }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
